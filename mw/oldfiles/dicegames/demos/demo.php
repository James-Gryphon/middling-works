...
?>
<br>
<div class="groupbox" id="semis"><b><span class='z5'>The Semi-Finals</span></b><br>
...
<br><div class="groupbox" id="finals"><b><span class='z6'>The Ephemeral Dice Tournament Finals</span></b><br><br
<div class="setbox">
...
?> </div> <?php
echo "<br><div id='celebration' style=\"color:#$winner->color; background:#{$winner->color}1\">$winner->name wins the Championship!!</div>";
?>
</div>
<span class='z3'>Roster: 1</span><br>
<span class='z3'>Version: 1.1JS</span>
</div>
</center>
